...
LastEditTime : 2022-01-06 10:16:46
LastEditors  : windz
FilePath     : /undefined/data/Zhaijx/mowp/data/nanopore_data/Repository/script/add_tag_to_bam.py
'''
    ...
    for read in inbam:
        if read.query_name in adapter_info_:
            ...
            try:
                ...
                print('Read is unmapped', read.query_name)
                continue
